...
class BusTrackerSaidaDebbiehPage extends StatefulWidget {
  final String routeTitle;
  final String busTime;
  final String tripId;

  const BusTrackerSaidaDebbiehPage({
    super.key,
  ...
  @override
  State<BusTrackerSaidaDebbiehPage> createState() =>
      _BusTrackerSaidaDebbiehPageState();
}

class _BusTrackerSaidaDebbiehPageState
    extends State<BusTrackerSaidaDebbiehPage> {
  ...
  final List<_StopModel> stops = const [
    _StopModel(name: 'Sahet El Nejmeh', progress: 0.00, minuteFromStart: 0),
    _StopModel(name: 'Awali', progress: 0.25, minuteFromStart: 10),
    _StopModel(name: 'Jiyeh', progress: 0.50, minuteFromStart: 20),
    _StopModel(name: 'Damour', progress: 0.75, minuteFromStart: 30),
    _StopModel(name: 'Debbieh', progress: 1.00, minuteFromStart: 40),
  ];
