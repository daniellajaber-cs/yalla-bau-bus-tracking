...
class BusTrackerDebbiehSaidaPage extends StatefulWidget {
  final String routeTitle;
  final String busTime;
  final String tripId;

  const BusTrackerDebbiehSaidaPage({
    super.key,
  ...
  @override
  State<BusTrackerDebbiehSaidaPage> createState() =>
      _BusTrackerDebbiehSaidaPageState();
}

class _BusTrackerDebbiehSaidaPageState
    extends State<BusTrackerDebbiehSaidaPage> {
  ...
  final List<_StopModel> stops = const [
    ...
    _StopModel(name: 'Damour', progress: 0.25, minuteFromStart: 10),
    _StopModel(name: 'Jiyeh', progress: 0.50, minuteFromStart: 20),
    _StopModel(name: 'Awali', progress: 0.75, minuteFromStart: 30),
    _StopModel(name: 'Sahet El Nejmeh', progress: 1.00, minuteFromStart: 40),
  ];
